...
urlpatterns = [
    ...
    path("refund/<int:pay_history_id>",
         views.PayView.as_view(), name="pay_history_id_view"),
    path("pay_histroy/<int:pay_history_id>",
         views.DetailPayHistoryView.as_view(), name="detail_pay_history_id_view"),
]
